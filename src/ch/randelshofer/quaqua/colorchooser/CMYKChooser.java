/*
 * @(#)CMYKChooser.java  1.2  2005-09-05
 *
...
implements UIResource {
    ...
    public CMYKChooser() {
        ...
        ccModel.getBoundedRangeModel(2).addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                if (! yellowField.hasFocus()) {
                    yellowField.setText(Integer.toString(ccModel.getBoundedRangeModel(2).getValue()));
                }
            }
        });
        ccModel.getBoundedRangeModel(3).addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent e) {
                if (! blackField.hasFocus()) {
                    blackField.setText(Integer.toString(ccModel.getBoundedRangeModel(3).getValue()));
                }
            }
        });
        cyanField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            private void doChanged() {
                if (cyanField.hasFocus()) {
                    try {
                        int value = Integer.decode(cyanField.getText()).intValue();
        ...
        magentaField.getDocument().addDocumentListener(new DocumentListener() {
            public void changedUpdate(DocumentEvent evt) {
                doChanged();
            }
            public void removeUpdate(DocumentEvent evt) {
            ...
            private void doChanged() {
                if (magentaField.hasFocus()) {
                    try {
                        int value = Integer.decode(magentaField.getText()).intValue();
                        if (0 <= value && value <= 100) {
        ...
        yellowField.getDocument().addDocumentListener(new DocumentListener() {
            public void changedUpdate(DocumentEvent evt) {
                doChanged();
            }
            public void removeUpdate(DocumentEvent evt) {
            ...
            private void doChanged() {
                if (yellowField.hasFocus()) {
                    try {
                        int value = Integer.decode(yellowField.getText()).intValue();
                        if (0 <= value && value <= 100) {
        ...
        blackField.getDocument().addDocumentListener(new DocumentListener() {
            public void changedUpdate(DocumentEvent evt) {
                doChanged();
            }
            public void removeUpdate(DocumentEvent evt) {
            ...
            private void doChanged() {
                if (blackField.hasFocus()) {
                    try {
                        int value = Integer.decode(blackField.getText()).intValue();
                        if (0 <= value && value <= 100) {
                            ccModel.getBoundedRangeModel(3).setValue(value);
                        }
                    } catch (NumberFormatException e) {
                        System.out.println(e);
                    }
    ...
    public String getDisplayName() {
        return labels.getString("ColorChooser.cmykSliders");
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        cyanLabel.setText(labels.getString("ColorChooser.cmykCyanText"));
        ...
        magentaLabel.setText(labels.getString("ColorChooser.cmykMagentaText"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.insets = new java.awt.Insets(1, 0, 0, 0);
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTHWEST;
        ...
        yellowLabel.setText(labels.getString("ColorChooser.cmykYellowText"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.insets = new java.awt.Insets(1, 0, 0, 0);
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTHWEST;
        ...
        blackLabel.setText(labels.getString("ColorChooser.cmykBlackText"));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.insets = new java.awt.Insets(1, 0, 0, 0);
        gridBagConstraints.anchor = java.awt.GridBagConstraints.SOUTHWEST;
