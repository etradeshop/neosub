/*
 * @(#)QuaquaUtilities.java  3.0  2005-09-24
 *
 ...
 * @version 3.0 2005-09-24 Removed all reflection helper methods. Moved Sheet
...
public class QuaquaUtilities extends BasicGraphicsUtils implements SwingConstants {
    ...
    public static boolean isOnActiveWindow(Component c) {
        ...
        // If we missed the client property, we have to figure out the activation
        // state on our own.
        ...
        if (window == null) {
            ...
            return Methods.invokeGetter(window, "isActive", true);
        } else {
            if (Methods.invokeGetter(window, "getFocusableWindowState", true)) {
                return Methods.invokeGetter(window, "isFocused", true);
            } else {
                return true;
            }
        }
